...
#    pragma omp single
        ...
        {
#if defined(_OPENMP) && !defined(PYTHON_INTERFACE)
#    pragma omp taskloop default(none) shared(leaves, get_input_cluster, get_output_cluster, temp, local_output_offset, local_input_offset, trans, in)
#endif
...
#    pragma omp single
            ...
            {
#if defined(_OPENMP) && !defined(PYTHON_INTERFACE)
#    pragma omp taskloop default(none) shared(leaves_for_symmetry, get_input_cluster, get_output_cluster, temp, local_output_offset, local_input_offset, trans_sym, in)
#endif
