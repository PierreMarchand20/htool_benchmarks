...
# Scripts
./bench_hmatrix_build_vs_pbl_size --benchmark_out=bench_hmatrix_build.json --benchmark_out_format=json --benchmark_enable_random_interleaving=true --benchmark_time_unit=us --benchmark_min_warmup_time=0.2 --benchmark_repetitions=9 --benchmark_min_time=0.1s --benchmark_counters_tabular=true
