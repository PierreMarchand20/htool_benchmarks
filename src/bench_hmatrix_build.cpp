...
TODO :
- faire plot
- Vérifier que l'implémentation NEW donne les memes résultats que la OLD
- ajouter un setup (et un teardown) -> bloqué
- Màj ReadMe
- deux types de BM :
...
- Tester différente complexité, best guest so far : NLogN ? - Changer N en n_rows.
...
/* Includes in test_hmatrix_build.hpp : */
...
// bool test_hmatrix_build_bis(GeneratorTestDoubleSymmetric generator, std::unique_ptr<HMatrixTreeBuilder<double, htool::underlying_type<double>>> hmatrix_tree_builder) {
//     // build
...
// static void DoSetupOld(benchmark::State &state) {
//     int nr                                                                                           = state.range(0);
//     int nc                                                                                           = state.range(1);
//     bool use_local_cluster                                                                           = state.range(2);
//     char Symmetry                                                                                    = state.range(3);
//     char UPLO                                                                                        = state.range(4);
//     htool::underlying_type<double> epsilon                                                           = state.range(5);
//     bool use_dense_blocks_generator                                                                  = state.range(6);
//     GeneratorTestDoubleSymmetric generator                                                           = state.range(7);
//     std::unique_ptr<HMatrixTreeBuilder<double, htool::underlying_type<double>>> hmatrix_tree_builder = state.range(8);
...
//     // Generator
//     // GeneratorTestDoubleSymmetric generator(3, nr, nc, p1_permuted, p2_permuted, *target_root_cluster, *source_root_cluster, false, false);
//     generator(3, nr, nc, p1_permuted, p2_permuted, *target_root_cluster, *source_root_cluster, false, false);
...
/* Define benchmark of the old implementation */
// GeneratorTestDoubleSymmetric generator;
