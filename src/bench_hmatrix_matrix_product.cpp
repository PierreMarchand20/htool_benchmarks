...
int main(int argc, char *argv[]) {
    ...
    if (generator_type == "Laplace")
        bench_hmatrix_matrix_product<FixtureHMatrix, FixtureGenerator, OptimizedLaplaceLikeGenerator>(test_case_type, symmetry_type, generator_type, clustering_type, low_rank_generator_type);
    else if (generator_type == "Helmholtz")
        bench_hmatrix_matrix_product<FixtureHMatrix, FixtureGenerator, OptimizedHelmholtzLikeGenerator>(test_case_type, symmetry_type, generator_type, clustering_type, low_rank_generator_type);
