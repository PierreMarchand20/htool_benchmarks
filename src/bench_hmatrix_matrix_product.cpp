/// This program benchmarks the H-matrix matrix product process using the
...
int main(int argc, char *argv[]) {
    ...
    bench_hmatrix_matrix_product<FixtureHMatrix<FixtureGenerator<LaplaceLikeGenerator>>>(test_case_name, symmetry_type);
